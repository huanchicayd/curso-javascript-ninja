(function(){
  ...
  */
  ...
  var palavras = 'Os meses de janeiro, junho e julho começam com a letra j.';
  console.log(palavras.match(
    /ju[nl]ho/g
  ));
  ...
  */
  ...
  var novasTags = '<div><ul><li></li><li></li><li><span></span></li></ul></div>';
  console.log(novasTags.match(/<\w+><\/\w+>/g));
  ...
  */
  ...
  var tagsexp = '<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>';
  console.log(tagsexp.replace(/<(\w+)>([^<]+)<\/\w+>/g, '<$1>O texto dentro da tag "$1" é "$2"</$1>\n'));
